        ...
        <div style={styles.card}>
          ...
          <section style={styles.section}>
            ...
            <p style={styles.paragraph}>
              تحرص المنصة على ألا يُنشر فيها إلا ما غلب على الظن سلامةُ حقِّ التصرف فيه. وعليه يُمنع منعًا باتًّا عرضُ أو طلبُ الرهن الربوي <span style={{color:"#c0392b", fontWeight:900}}>(الرهنية)</span>، أو الترويج له، أو التوسط فيه بأي صورة كانت.
            </p>
            <p style={{...styles.paragraph, marginTop: 10}}>
              كما يُمنع نشرُ أي إعلان يتعلق بعقارٍ أُقيم على <span style={{color:"#c0392b", fontWeight:900}}>أرضٍ استُلبت</span> من أصحابها بغير حق، أو انتُزعت حقوقُهم فيها ظلمًا أو عدوانًا، أو بعقارٍ ترتب على إرثٍ شابه التواطؤ على <span style={{color:"#c0392b", fontWeight:900}}>أكل الحقوق</span> أو حرمانُ مستحقيها منها، أو بعقارٍ أُنشئ أو شُيِّد أو استُعمل على وجهٍ يخالف الحق أو يعتدي على ملك الغير.
            </p>
            <p style={{...styles.paragraph, marginTop: 10}}>
